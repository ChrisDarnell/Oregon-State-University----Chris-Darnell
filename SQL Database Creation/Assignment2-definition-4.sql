...
CREATE TABLE client (
  ...
  dob DATE,
  PRIMARY KEY (id),
  KEY idx_client_first_name_last_name (first_name, last_name) 
...
CREATE TABLE employee (
  ...
  date_joined DATE,
  PRIMARY KEY (id),
  KEY idx_employee_first_name_last_name (first_name, last_name) 
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE project (
  ...
  CONSTRAINT `cid_project_client` FOREIGN KEY (cid) REFERENCES client (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE works_on (
  ...
  start_date DATE,
  PRIMARY KEY (eid, pid),
  CONSTRAINT `eid_works_on_employee` FOREIGN KEY (eid) REFERENCES employee (id),
  CONSTRAINT `pid_works_on_project` FOREIGN KEY (pid) REFERENCES project (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
