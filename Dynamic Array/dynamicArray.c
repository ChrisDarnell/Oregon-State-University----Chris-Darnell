...
/* Author: Chris Darnell
 Date: 10/9/16
 Description: CS261-400 Assignment 2 dynamicArray.c
 
 Solution: Since many pre tests involve v being not null, we use an assert to test this and other parameters throughout. Using pointers and for loops to increment the index counte,. data can be added or removed from the array as needed. The array can be resized and the capacity doubled as well. */
